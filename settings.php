<?php
	...
	$settings -> add(new admin_setting_configselect('block_coursefeedback/active_feedback', get_string('adminpage_html_submitters1a', 'block_coursefeedback'),
			get_string('adminpage_html_submitters1b', 'block_coursefeedback'), 0, $options));
	$settings -> add(new admin_setting_configselect('block_coursefeedback/default_language', get_string('adminpage_html_submitters2a', 'block_coursefeedback'),
			get_string('adminpage_html_submitters2b', 'block_coursefeedback'), $CFG->lang, $langs));
