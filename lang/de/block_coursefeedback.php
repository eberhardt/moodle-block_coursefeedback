...
$string['course_settings_of'] = 'Evaluationseinstellungen: {$a}';
$string['course_survey_status'] = 'Aktueller Status';
$string['coursecat_assignment_conflict'] = 'Der Kursbereich {$a->cat_name} ist bereits der Organisationseinheit {$a->org_name} zugeordnet.';
...
$string['event_types'] = 'Standard-Fragebogen und Veranstaltungsarten';
...
$string['has_local_questionnaires'] = 'Eigene Fragebögen auf Organisations-Ebene verwalten';
...
$string['no_global_questionnaires'] = 'Globale Fragebögen ausschließen';
...
$string['only_editable_by_admins'] = 'Einige Einstellungen können nur durch zentrale Evaluationskoordinator/innen geändert werden.';
$string['option_amount'] = 'Anzahl von Antwortmöglichkeiten';
$string['organization'] = 'Organisation';
$string['organization_questionnaires'] = 'Fragebögen, die zu {$a} gehören';
$string['organization_settings'] = 'Organisations-Einstellungen';
...
$string['questionnaire_scope'] = 'Fragebogen-Geltungsbereich';
$string['questionnaire_scope_help'] = 'Diese Einstellungen geben an, welche Fragebögen in dieser Organisation als Standard-Fragebogen und LV-Fragebögen verwendbar sind. Fragebögen, die vor Änderung dieser Einstellungen ausgewählt wurden, werden dennoch verwendet, bis sie manuell ersetzt werden.';
$string['questionnaires'] = 'Fragebögen';
$string['questionnaires_in'] = 'Fragebögen: {$a}';
...
$string['teacher_permissions'] = 'Trainer/innen-Berechtigungen';
