...
$string['can_have_local_questionnaires'] = 'This organization manages its own questionnaires';
...
$string['disallow_global_questionnaires'] = 'Prevent the use of globally managed questionnaires';
...
$string['questionnaire_restriction_note'] = 'The following settings change which questionnaires are available as the default questionnaire and when defining event types. Questionnaires selected before changing these settings may still be used if not manually updated.';
