...
$string['course_settings_of'] = 'Survey settings: {$a}';
$string['course_survey_status'] = 'Current survey status';
$string['coursecat_assignment_conflict'] = 'The course category {$a->cat_name} is already assigned to organization {$a->org_name}.';
...
$string['event_types'] = 'Event types and default questionnaire';
...
$string['has_local_questionnaires'] = 'This organization manages its own questionnaires';
...
$string['no_global_questionnaires'] = 'Prevent the use of globally managed questionnaires';
...
$string['only_editable_by_admins'] = 'Some settings can only be changed by central evaluation coordinators.';
$string['option_amount'] = 'Amount of options';
$string['organization'] = 'Organization';
$string['organization_questionnaires'] = 'Questionnaires belonging to {$a}';
$string['organization_settings'] = 'Organization settings';
...
$string['questionnaire_scope'] = 'Questionnaire scope';
$string['questionnaire_scope_help'] = 'These settings change which questionnaires are available as the default questionnaire and when defining event types. Questionnaires selected before changing these settings may still be used if not manually updated.';
$string['questionnaires'] = 'Questionnaires';
$string['questionnaires_in'] = 'Questionnaires: {$a}';
...
$string['teacher_permissions'] = 'Teacher permissions';
